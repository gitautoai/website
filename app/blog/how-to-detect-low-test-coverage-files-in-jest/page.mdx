...
GitAuto will automatically process the coverage reports [here](/settings/coverage):
...
For more examples of how GitAuto can help with testing, check out our guides on [adding unit tests](/blog/add-a-unit-test) and [widget tests](/blog/how-to-add-widget-tests).

Questions or feedback? Contact us at [info@gitauto.com](mailto:info@gitauto.com).
