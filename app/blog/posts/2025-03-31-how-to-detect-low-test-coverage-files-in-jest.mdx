export const metadata = {
  title: "How to Detect Low Test Coverage Files in Jest",
  description:
    "A step-by-step guide on setting up test coverage reporting in Jest (JavaScript / TypeScript) projects and using GitAuto to improve coverage automatically.",
  slug: "how-to-detect-low-test-coverage-files-in-jest",
  alternates: { canonical: "/blog/how-to-detect-low-test-coverage-files-in-jest" },
  openGraph: { url: "/blog/how-to-detect-low-test-coverage-files-in-jest" },
  author: "Wes Nishio",
  authorUrl: "https://www.linkedin.com/in/hiroshi-nishio/",
  tags: ["solution", "Jest", "JavaScript", "TypeScript", "Test Coverage", "GitHub Actions"],
...
![GitHub Actions Workflow Setup](/blog/how-to-detect-low-test-coverage-files-in-jest/step2.png)
...
![Selecting Files for Coverage Improvement](/blog/how-to-detect-low-test-coverage-files-in-jest/step4-1.png)

![Creating Issues from Actions Menu](/blog/how-to-detect-low-test-coverage-files-in-jest/step4-2.png)

![Successfully Created Issues](/blog/how-to-detect-low-test-coverage-files-in-jest/step4-3.png)
...
![Created Issue Example](/blog/how-to-detect-low-test-coverage-files-in-jest/step4-4.png)

![Issues List View](/blog/how-to-detect-low-test-coverage-files-in-jest/step4-5.png)
...
- **[Flutter Coverage Detection](/blog/how-to-detect-low-test-coverage-files-in-flutter)** - Similar coverage setup guide for Flutter/Dart projects.
