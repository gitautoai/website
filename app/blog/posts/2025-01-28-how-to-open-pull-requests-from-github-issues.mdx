export const metadata = {
  ...
  slug: "how-to-open-pull-requests-from-github-issues",
...
- Free Plan: $21 free credits (3 PRs)
- Standard Plan: $7 per PR with $10 minimum purchase
- Enterprise Plan: Custom pricing with advanced features

Important notes about credit usage:

- Each PR costs $7 in credits
...
- When bulk assigning issues, each resulting PR counts separately (e.g., assigning 10 issues that each create PRs consumes $70 in credits)
...
![VSCode's open issues count](/blog/how-to-open-pull-requests-from-github-issues/step7-1.png)
...
![VSCode's closed issues in last 3 months](/blog/how-to-open-pull-requests-from-github-issues/step7-2.png)
