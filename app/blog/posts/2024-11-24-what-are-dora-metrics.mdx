export const metadata = {
  ...
  alternates: { canonical: "/blog/what-are-dora-metrics" },
  openGraph: { url: "/blog/what-are-dora-metrics" },
  author: "Wes Nishio",
...
[GitAuto](/) is a coding agent that automatically writes unit tests and opens pull requests, running 24/7 via scheduled triggers, dashboard selection, review comments, and test failure detection. By automating test generation, GitAuto shortens **Change Lead Time**, increases **Deployment Frequency**, and shortens **Failed Recovery Time**, directly improving your **Software Delivery Performance**.
