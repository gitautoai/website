export const metadata = {
  ...
  slug: "ask-a-file-dont-read-the-whole-thing",
  alternates: { canonical: "/blog/ask-a-file-dont-read-the-whole-thing" },
  openGraph: { url: "/blog/ask-a-file-dont-read-the-whole-thing" },
  author: "Wes Nishio",
