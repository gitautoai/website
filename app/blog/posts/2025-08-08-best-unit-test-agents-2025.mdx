...
**Triggers:** Dashboard file selection, review comments, test failures, schedule triggers, PR changes, PR merges

**Output:** GitHub pull requests

**Languages:** Language-agnostic (works with any language and testing framework)

**Pricing:** Free ($24 credits, 3 PRs), Standard ($8/PR, min $10), Enterprise (custom pricing)
