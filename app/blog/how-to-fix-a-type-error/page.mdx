export const metadata = {
  title: "How to Fix TypeError: 'NoneType' object is not iterable with Sentry and GitAuto",
  description: "A step-by-step guide on how to fix a TypeError caught by Sentry using GitAuto.",
  alternates: { canonical: "/blog/how-to-fix-a-type-error" },
  openGraph: { url: "/blog/how-to-fix-a-type-error" },
  author: "Wes Nishio",
...
# How to Fix TypeError: 'NoneType' object is not iterable with Sentry and GitAuto

Let's walk through fixing a TypeError caught by [Sentry](https://sentry.io) using GitAuto. We'll cover the process from error detection to pull request creation.
