...
const PR_COUNT_THRESHOLD = 10000;
...
export default function Stats() {
  ...
  const testPassRate = stats.testPassRate ?? FALLBACK.testPassRate;
  const mergeRate = stats.mergeRate ?? FALLBACK.mergeRate;
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-16">
        <div className="text-center">
          <p className="text-4xl md:text-5xl font-bold text-pink-600">
            {roundDown(stats.totalRepos)}+
          </p>
          <p className="text-gray-600 mt-1">Repositories</p>
        </div>
        {showPrCount && (
          <div className="text-center">
            <p className="text-4xl md:text-5xl font-bold text-pink-600">
        ...
        <div className="text-center">
          <p className="text-4xl md:text-5xl font-bold text-pink-600">{testPassRate.toFixed(1)}%</p>
          <p className="text-gray-600 mt-1">Test pass rate</p>
        </div>
        <div className="text-center">
          <p className="text-4xl md:text-5xl font-bold text-pink-600">{mergeRate.toFixed(1)}%</p>
