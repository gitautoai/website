    ...
    rules: [
      {
        ...
        examples: {
          "Auto-detect from repo":
            "Analyze existing test files in the project to determine location pattern",
          "Co-located with source": "src/utils/foo.ts → src/utils/foo.test.ts",
          "__tests__ subdirectory": "src/utils/foo.ts → src/utils/__tests__/foo.test.ts",
          "Separate test directory": "src/utils/foo.ts → tests/utils/foo.test.ts",
        },
      },
      {
