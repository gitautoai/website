...
export const chartsJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": ABSOLUTE_URLS.GITAUTO.DASHBOARD.COVERAGE_TRENDS + "#webapplication",
  ...
  url: ABSOLUTE_URLS.GITAUTO.DASHBOARD.COVERAGE_TRENDS,
  ...
  screenshot: {
    "@type": "ImageObject",
    url: THUMBNAILS.DASHBOARD.COVERAGE_TRENDS,
