...
export const coverageJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": ABSOLUTE_URLS.GITAUTO.DASHBOARD.FILE_COVERAGE + "#webapplication",
  ...
  url: ABSOLUTE_URLS.GITAUTO.DASHBOARD.FILE_COVERAGE,
  ...
  screenshot: {
    "@type": "ImageObject",
    url: THUMBNAILS.DASHBOARD.FILE_COVERAGE,
