            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatBlock
                  ...
                  selectedPeriodValue={totalStats.selected_period.total_open_prs}
                  showUpdatePRs={true}
                  repoName="__ALL__"
