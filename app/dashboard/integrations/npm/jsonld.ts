...
export const npmJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": ABSOLUTE_URLS.GITAUTO.DASHBOARD.INTEGRATIONS.NPM + "#webapplication",
  name: `npm Integration - ${PRODUCT_NAME}`,
  description: DESCRIPTION,
  url: ABSOLUTE_URLS.GITAUTO.DASHBOARD.INTEGRATIONS.NPM,
  creator: CREATOR,
  audience: AUDIENCE,
  ...
  screenshot: {
    "@type": "ImageObject",
    url: THUMBNAILS.DASHBOARD.INTEGRATIONS.NPM,
    description:
