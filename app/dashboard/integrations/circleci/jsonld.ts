...
export const circleCIJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": ABSOLUTE_URLS.GITAUTO.DASHBOARD.INTEGRATIONS.CIRCLECI + "#webapplication",
  name: `CircleCI Integration - ${PRODUCT_NAME}`,
  description: DESCRIPTION,
  url: ABSOLUTE_URLS.GITAUTO.DASHBOARD.INTEGRATIONS.CIRCLECI,
  creator: CREATOR,
  audience: AUDIENCE,
  ...
  screenshot: {
    "@type": "ImageObject",
    url: THUMBNAILS.DASHBOARD.INTEGRATIONS.CIRCLECI,
    description:
