  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(parentIssueRulesJsonLd) }}
      />
      <div className="w-full max-w-3xl mx-auto py-8">
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <p className="text-lg text-gray-700">
            Parent issues allow you to define common rules and guidelines that GitAuto will apply
            when generating tests for child issues. This ensures consistency across all your test
            generation tasks.
          </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p>
                ...
                guidelines. When you create child issues for test generation, GitAuto uses the
                parent issue content as a system prompt, ensuring all generated tests follow the
                same standards.
              </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
                      <li>
                        Place test files next to the target files instead of creating a separate
                        tests folder. Do not use dedicated test directories like `tests/` or
                        `__tests__`
                      </li>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    As you learn what works best for your project, update the parent issue rules.
                    All future child issues will use the updated rules.
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="bg-yellow-50 p-4 rounded-md">
                <ul className="list-disc pl-6 space-y-2 text-sm text-yellow-800">
                  ...
                  <li>
                    <strong>Repository Scope:</strong> Parent issues must be in the same repository
                    as the files you&apos;re testing.
                  </li>
                </ul>
              </div>
