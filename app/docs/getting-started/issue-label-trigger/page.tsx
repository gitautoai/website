...
export const metadata: Metadata = {
  title: "GitHub Issues Label - Getting Started with GitAuto",
  description: "Learn how to use GitHub issue labels to trigger GitAuto test generation.",
};
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(issueLabelTriggerJsonLd) }}
      />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p>
                ...
                and type &quot;gitauto&quot; in the search field. If the label doesn&apos;t exist
                yet, GitHub will let you create it on the fly by clicking on &quot;Create new
                label&quot; or pressing Enter.
              </p>
            ...
            <div>
              ...
              <p>
                ...
                in a comment on the issue. Review the code, make any necessary adjustments, and
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-8">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li>
                  <strong>Integration with external tools:</strong> Tools like Sentry, Jira, or
                  other issue trackers can be configured to automatically create GitHub issues with
                  the &quot;gitauto&quot; label when certain events occur.
                </li>
                <li>
                  <strong>Automated testing workflows:</strong> You can set up GitHub Actions or
                  other CI/CD workflows to add the &quot;gitauto&quot; label to issues based on
                  specific criteria, triggering test generation automatically.
                </li>
                <li>
