  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(issueCheckboxTriggerJsonLd) }}
      />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p>
                ...
                box to trigger GitAuto to analyze your issue and generate test cases and a pull
                request.
              </p>
              <div className="mt-4 bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
                  <strong>Note:</strong> For existing issues without the GitAuto checkbox, you can
                  add the &quot;gitauto&quot; label to trigger the same functionality. No worries,
            ...
            <div>
              ...
              <p>
                GitAuto will create a pull request with the generated tests. Review the code, make
                any necessary adjustments, and merge the pull request to add the tests to your
                repository.
              </p>
            </div>
          </div>
