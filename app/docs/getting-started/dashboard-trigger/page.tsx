  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dashboardTriggerJsonLd) }}
      />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p>
                ...
                . The dashboard will display a list of organizations and repositories where GitAuto
                is installed.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-4 bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
                  <strong>Note:</strong> If you don&apos;t see your repository, verify that GitAuto
                  is installed for that organization and that you have appropriate permissions.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2 mb-4">
                <li>
                  <strong>Define common rules</strong> - Write shared testing rules and guidelines
                  in the parent issue that will be applied to all child issues
                </li>
                <li>
                ...
                <li>
                  <strong>Reuse system prompts</strong> - The parent issue content serves as a
                  system prompt for GitAuto when generating tests
                </li>
              </ul>
            ...
            <div>
              ...
              <p>
                ...
                starting with smaller files. Then click the pink &quot;Actions&quot; button and
                choose either:
              </p>
