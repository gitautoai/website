...
export default function AutoMergePage() {
  return (
    <>
      <h1 className="text-4xl font-bold mb-8">Auto-Merge</h1>

      <div className="space-y-12">
        <section>
          <p className="text-gray-600 mb-4">
            Automatically merge GitAuto pull requests when all tests pass and conditions are met.
            Save time by eliminating manual PR merging for test generation tasks.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">How Auto-Merge Works</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Who Should Use This</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Enabling Auto-Merge</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-4">Configuration Steps</h3>
          <ol className="list-decimal pl-8 text-gray-600 space-y-3">
            ...
            <li>
              In the search field, type <strong>git</strong> and select <strong>gitauto-ai</strong>{" "}
              from the dropdown
            </li>
          </ol>
          ...
          <div className="mt-4 bg-blue-50 p-4 rounded-md">
            ...
            <ul className="list-disc pl-8 space-y-1 text-sm text-blue-800">
        ...
        <section>
          ...
          <div className="bg-yellow-50 p-4 rounded-md">
            ...
            <ul className="list-disc pl-8 space-y-1 text-sm text-yellow-800">
