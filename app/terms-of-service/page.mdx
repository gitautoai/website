...
# GitAuto Terms of Service

### Last updated April 19, 2024

## AGREEMENT TO OUR LEGAL TERMS

We are GitAuto, Inc. ("**Company**," "**we**," "**us**," "**our**"), a company registered in
California, United States at 44 Tehama St, San Francisco, CA 94105.

<br />
We operate the website [https://gitauto.ai](https://gitauto.ai) (the "**Site**"),
...
<br />
You can contact us by phone at [+1 (925) 263-9820](tel:+19252639820), email at [info@gitauto.ai](mailto:info@gitauto.ai),
or by mail to 44 Tehama St, San Francisco, CA 94105, United States.

<br />
These Legal Terms constitute a legally binding agreement made between you, whether
personally or on behalf of an entity ("**you**"), and GitAuto, Inc., concerning your
...
[info@gitauto.ai](mailto:info@gitauto.ai). If we ever grant you the permission to post, reproduce, or publicly
...
unlimited, irrevocable, perpetual, non-exclusive, transferable, royaltyfree, fully-paid,
worldwide right, and license to: use, copy, reproduce, distribute, sell, resell,
publish, broadcast, retitle, store, publicly perform, publicly display, reformat,
translate, excerpt (in whole or in part), and exploit your Contributions (including,
without limitation, your image, name, and voice) for any purpose, commercial, advertising,
...
applicable order. The length of your billing cycle will depend on the type of subscription plan you choose when you subscribed to the Services.
...
questions or are unsatisfied with our Services, please email us at [info@gitauto.ai](mailto:info@gitauto.ai).
...
Policy: [https://gitauto.ai/privacy-policy](https://gitauto.ai/privacy-policy). By using the Services, you agree to be
...
and federal courts located in California, and the Parties hereby consent to, and waive
all defenses of lack of personal jurisdiction and forum non conveniens with respect to
...
In no event shall any claim, action, or proceeding brought by either Party related in
any way to the Services be commenced more than one year after the cause of
action arose.
...
California 95834 or by telephone at [+1 (800) 952-5210](tel:+18009525210) or [+1 (916) 445-1254](tel:+19164451254).
...
Phone: [+1 (925) 263-9820](tel:+19252639820)\
