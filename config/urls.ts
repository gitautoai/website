  ...
  DOCS: {
    ...
    HOW_IT_WORKS: {
      ...
      QUALITY_VERIFICATION: {
        ...
        PYTEST_SUPPORT: "/docs/how-it-works/quality-verification/pytest-support",
    ...
    DOCS: {
      ...
      HOW_IT_WORKS: {
        ...
        QUALITY_VERIFICATION: {
          ...
          PYTEST_SUPPORT: `${BASE_URL}${RELATIVE_URLS.DOCS.HOW_IT_WORKS.QUALITY_VERIFICATION.PYTEST_SUPPORT}`,
